...
const city: CitySave = { v: SAVE_VERSION, terrain: "rolling", hour: 14, day: 1, money: STARTING_MONEY, resources: new CityEconomy().resources, run: createRun(), waveClock: createWaveClock(), elapsed: 0, nodes: [], segments: [], planted: [], cleared: [], zones: [], rubble: [], buildingStates: [], utilities: [] };
